...
export const REALIZATIONS: Realization[] = [
  {
    ...
    title: 'Zbiorniki ppoż. i chemiczne dla europejskiego parku wodnego',
    summary:
      'Suntago to największy kryty park wodny w Europie, działający pod marką Park of Poland, oferujący strefy tematyczne, liczne zjeżdżalnie, baseny i saunarium. Dostarczyliśmy zbiornik przeciwpożarowy 20 m³ zasilający instalację tryskaczową oraz dwa zbiorniki na kwasy 3000 l ze stali kwasoodpornej do obiegu reagentów uzdatniania wody basenowej.',
  ...
  },
  {
    ...
    summary:
      'Swiss Krono produkuje płyty drewnopochodne i podłogi laminowane w Żarach. Dostarczyliśmy dwa zbiorniki na wodę pitną 5000 l ze stali nierdzewnej 1.4301 z atestem PZH, stanowiące zapas wody uzdatnionej dla zaplecza socjalnego.',
  ...
  },
  {
    ...
    summary:
      'Schmid Energy buduje kotłownie i systemy energetyczne na biomasę. Dostarczyliśmy zbiornik na wodę pitną 5000 l ze stali nierdzewnej 1.4301 z atestem PZH jako zapas wody uzupełniającej dla instalacji kotłowej.',
