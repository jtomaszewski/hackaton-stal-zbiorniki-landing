...
export default function InStockPage() {
  ...
  return (
    <section data-in-stock-list className="mx-auto max-w-6xl px-4 py-12">
      <h1 className="font-display text-4xl font-bold uppercase">Zbiorniki od ręki</h1>
      <p className="mt-2 text-steel-700">Gotowe zbiorniki z magazynu w Kobierzycach. Wysyłka w kilka dni roboczych.</p>
      <div className="mt-8">
        {inStock.length ? (
          <ProductGrid products={inStock} />
        ) : (
          <p className="rounded-sm border border-steel-100 bg-white p-6">
